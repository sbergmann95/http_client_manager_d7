...
class HttpClient implements HttpClientInterface {
   ...
   */
  public function __construct($serviceApi, HttpServiceApiHandlerInterface $apiHandler) {
  ...
  public function getClientConfig() {
    ...
    // Invoke a hook so modules can add to the stack by implementing the hook.
    drupal_alter('http_client_manager_handler_stack', $config['handler'], $this->serviceApi);
